...
import reactBasicImage from '../components/Footer/React-Basic.png'

const ReactBasicCourse = ({ data, location }) => {
          ...
          <div className="about-us">
            <div className="row content-container">
              <div className="col-12 col-md-4 col-lg-4 content-image">
                <img src={reactBasicImage} alt={post.frontmatter.title} />
...
export default ReactBasicCourse
