...
import awsConceptsImage from '../components/Footer/AWS-Concepts.png'

const AWSConceptCourse = ({ data, location }) => {
          ...
          <div className="about-us">
            <div className="row content-container">
              <div className="col-12 col-md-4 col-lg-4 content-image">
                <img src={awsConceptsImage} alt={post.frontmatter.title} />
                <div className="buy-in-post">
                  <Button
                    onClick={() => handleBuy('aws-concepts')}
                    variant="primary"
                    className="widthAll"
                  >
...
export default AWSConceptCourse
