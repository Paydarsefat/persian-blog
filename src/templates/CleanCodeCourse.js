...
import cleanCodeImg from '../components/Footer/Clean-Code.png'

const CleanCodeCourse = ({ data, location }) => {
          ...
          <div className="about-us">
            <div className="row content-container">
              <div className="col-12 col-md-4 col-lg-4 content-image">
                <img src={cleanCodeImg} alt={post.frontmatter.title} />
                <div className="buy-in-post">
                  {/* <SpecialMessage /> */}
                  <Button
                    onClick={() => handleBuy('clean-code')}
                    variant="primary"
                    className="widthAll"
                  >
...
export default CleanCodeCourse
