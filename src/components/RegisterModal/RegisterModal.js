                    ...
                    <div className="register-body">
                        ...
                        <div className="register-body-form">
                            ...
                            <Form.Group controlId="formBasicText">
                                ...
                                <Form.Control
                                    onChange={(event) => handleChangeRegisterForm('first_name',event)}
                                    type="text"
                            ...
                            <Form.Group controlId="formBasicText">
                                ...
                                <Form.Control
                                    onChange={(event) => handleChangeRegisterForm('last_name',event)}
                                    type="text"
                            ...
                            <Form.Group controlId="formBasicPassword">
                                ...
                                <Form.Control
                                    onChange={(event) => handleChangeRegisterForm('password',event)}
                                    type="password"
